            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        <th width="120">分类：</th>
                        <td>
                            <select name="cate_id" style="text-align: center">
                                @foreach($data as $classify)
                                <option value="{{$classify->id}}"
                                    @if($field->cate_id == $classify->id) selected @endif
                                >{{$classify->_name}}</option>
                                @endforeach
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>缩略图：</th>
                        <td>
                            <input type="text" size="50" name="thumb" readonly value="{{$field->thumb}}">
...
//                                            alert(data)
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img src="/blog/{{$field->thumb}}" alt="" id="thumb_img" style="max-width: 350px; max-height: 100px;">
                        </td>
                    </tr>
                    <tr>
                        <th>关键词：</th>
                        <td>
                            <input type="text" name="tag" class="lg" value="{{$field->tag}}">
                        </td>
                    </tr>
                    <tr>
                        <th>描述：</th>
