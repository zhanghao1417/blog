...
@section('content')
	...
	<div class="menu_box">
		<ul>
			<li>
				<h3><i class="fa fa-fw fa-heart"></i>常用操作</h3>
				<ul class="sub_menu">
			...
			<li>
				<h3><i class="fa fa-fw fa-outdent"></i>链接设置</h3>
				<ul class="sub_menu">
					<li><a href="{{url('admin/links/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加链接</a></li>
					<li><a href="{{url('admin/links')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>链接列表</a></li>
				</ul>
			</li>
			<li>
				<h3><i class="fa fa-fw fa-outdent"></i>导航设置</h3>
				<ul class="sub_menu">
			...
			<li>
				<h3><i class="fa fa-fw fa-codepen"></i>配置项设置</h3>
				<ul class="sub_menu">
					<li><a href="{{url('admin/config/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加配置项</a></li>
					<li><a href="{{url('admin/config')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>配置项列表</a></li>
				</ul>
			</li>
			<li>
