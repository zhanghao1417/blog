            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>类型：</th>
                        <td>
                            <input type="radio" name="type" value="input" onclick="show()">input&nbsp;&nbsp;
                            <input type="radio" name="type" value="textarea" onclick="show()">textarea &nbsp;&nbsp;
                            <input type="radio" name="type" value="radio" onclick="show()">radio
                        </td>
                    </tr>
                    <tr class="value">
                        <th>类型值：</th>
                        <td>
                            ...
                            <p><i class="fa fa-exclamation-circle yellow"></i>格式：1|开始，2|关闭（符号为中文逗号）</p>
                        </td>
                    </tr>
                    <tr>
                        <th>排序：</th>
                        <td>
                            <input type="text" class="sm" name="orders" value="0">
                        </td>
                    </tr>
                    <tr>
                        <th>说明：</th>
